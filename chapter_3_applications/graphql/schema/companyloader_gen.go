...
func (l *CompanyLoader) LoadThunk(key int64) func() (*Company, error) {
	...
	if l.batch == nil {
		l.batch = &companyBatch{done: make(chan struct{})}
	}
	batch := l.batch
...
func (l *CompanyLoader) unsafeSet(key int64, value *Company) {
	if l.cache == nil {
		l.cache = map[int64]*Company{}
	}
	l.cache[key] = value
}
...
func (b *companyBatch) keyIndex(l *CompanyLoader, key int64) int {
...
func (b *companyBatch) startTimer(l *CompanyLoader) {
	time.Sleep(l.wait)
	l.mu.Lock()
...
func (b *companyBatch) end(l *CompanyLoader) {
